...
const en: Bundle = {
  ...
  pages: {
    ...
    home: {
      ...
      emptyTagged: "No posts with this tag yet. Be the first to use it.",
      ...
      sidebarTrendingEmpty: "No trending tags this week — be the first to start one with #yourtag.",
    ...
    messages: {
      ...
      empty: "No conversations yet — open a profile and tap Message to start one.",
    },
    bannedPage: {
...
const ka: Bundle = {
  ...
  pages: {
    ...
    home: {
      ...
      emptyTagged: "ამ თეგით პოსტები ჯერ არ არის. იყავი პირველი.",
      ...
      sidebarTrendingEmpty: "ამ კვირაში ტრენდული თეგები ჯერ არ არის — დადე #შენი_თეგით პოსტი და დაიწყე ახალი ტალღა.",
    ...
    messages: {
      ...
      empty: "საუბრები ჯერ არ გაქვს — გახსენი ვინმეს პროფილი და დააჭირე „შეტყობინება“.",
    },
    bannedPage: {
...
const ru: Bundle = {
  ...
  pages: {
    ...
    home: {
      ...
      emptyTagged: "Постов с этим тегом пока нет. Будьте первым.",
      ...
      sidebarTrendingEmpty: "На этой неделе популярных тегов нет — будьте первым, кто запустит #свойтег.",
    ...
    messages: {
      ...
      empty: "Пока нет переписок — откройте профиль и нажмите «Сообщение», чтобы начать.",
    },
    bannedPage: {
